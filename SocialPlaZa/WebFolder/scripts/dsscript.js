...
appdsObj = function () {
	...
	this.estadoInicial = function ($comp,estado,objeto){
		...
		if(estado == "crear"){
			...
			sources.articulos1.query("Descripcion =:1",sources.articulos.Descripcion,{
	...
	this.pintarMenu = function(){
		...
		//Se averigua que elemento del 3ºnivel se ha pulsado;
		$(".proceso").click(function(){

			//$("#headComp_clickMenu").click();
		
		//Para que el el menú principal se cierre al elegir cualquier elemento:	
