...
//! toolbar2.js 2013-04-05 
"function"!=typeof Object.create&&(Object.create=function(t){function o(){}return o.prototype=t,new o}),function(t,o){var e={init:function(o,e){var i=this;i.elem=e,i.$elem=t(e),i.options=t.extend({},t.fn.toolbar2.options,o),i.toolbar2=t('<div class="tool-container gradient" />').addClass("tool-"+i.options.position).addClass("tool-rounded").append('<div class="tool-items" />').append('<div class="arrow" />').appendTo("body").css("opacity",0).hide(),i.toolbar2_arrow=i.toolbar2.find(".arrow"),i.initializetoolbar2()},initializetoolbar2:function(){var t=this;t.populateContent(),t.setTrigger(),t.toolbar2Width=t.toolbar2.width()},setTrigger:function(){var e=this;e.$elem.on("touchend",function(t){t.preventDefault(),e.$elem.hasClass("pressed")?e.hide():e.show()}),e.options.hideOntouchend&&t("html").on("touchend.toolbar2",function(t){t.target!=e.elem&&0===e.$elem.has(t.target).length&&0===e.toolbar2.has(t.target).length&&e.toolbar2.is(":visible")&&e.hide()}),t(o).resize(function(t){t.stopPropagation(),e.toolbar2.is(":visible")&&(e.toolbar2Css=e.getCoordinates(e.options.position,20),e.collisionDetection(),e.toolbar2.css(e.toolbar2Css),e.toolbar2_arrow.css(e.arrowCss))})},populateContent:function(){var o=this,e=o.toolbar2.find(".tool-items"),i=t(o.options.content).clone(!0).find("a").addClass("tool-item gradient");e.html(i),e.find(".tool-item").on("touchend",function(t){t.preventDefault(),o.$elem.trigger("toolbar2Itemtouchend",this)})},calculatePosition:function(){var t=this;t.arrowCss={},t.toolbar2Css=t.getCoordinates(t.options.position,0),t.toolbar2Css.position="absolute",t.toolbar2Css.zIndex=t.options.zIndex,t.collisionDetection(),t.toolbar2.css(t.toolbar2Css),t.toolbar2_arrow.css(t.arrowCss)},getCoordinates:function(t,o){var e=this;switch(e.coordinates=e.$elem.offset(),e.options.adjustment&&e.options.adjustment[e.options.position]&&(o=e.options.adjustment[e.options.position]),e.options.position){case"top":return{left:e.coordinates.left-e.toolbar2.width()/2+e.$elem.outerWidth()/2,top:e.coordinates.top-e.$elem.height()-o,right:"auto"};case"left":return{left:e.coordinates.left-e.toolbar2.width()/2-e.$elem.width()/2-o,top:e.coordinates.top-e.toolbar2.height()/2+e.$elem.outerHeight()/2,right:"auto"};case"right":return{left:e.coordinates.left+e.toolbar2.width()/2+e.$elem.width()/3+o,top:e.coordinates.top-e.toolbar2.height()/2+e.$elem.outerHeight()/2,right:"auto"};case"bottom":return{left:e.coordinates.left-e.toolbar2.width()/2+e.$elem.outerWidth()/2,top:e.coordinates.top+e.$elem.height()+o,right:"auto"}}},collisionDetection:function(){var e=this,i=20;("top"==e.options.position||"bottom"==e.options.position)&&(e.arrowCss={left:"50%",right:"50%"},i>e.toolbar2Css.left?(e.toolbar2Css.left=i,e.arrowCss.left=e.$elem.offset().left+e.$elem.width()/2-i):i>t(o).width()-(e.toolbar2Css.left+e.toolbar2Width)&&(e.toolbar2Css.right=i,e.toolbar2Css.left="auto",e.arrowCss.left="auto",e.arrowCss.right=t(o).width()-e.$elem.offset().left-e.$elem.width()/2-i-5))},show:function(){var t=this,o={opacity:1};switch(t.$elem.addClass("pressed"),t.calculatePosition(),t.options.position){case"top":o.top="-=20";break;case"left":o.left="-=20";break;case"right":o.left="+=20";break;case"bottom":o.top="+=20"}t.toolbar2.show().animate(o,200),t.$elem.trigger("toolbar2Shown")},hide:function(){var t=this,o={opacity:0};switch(t.$elem.removeClass("pressed"),t.options.position){case"top":o.top="+=20";break;case"left":o.left="+=20";break;case"right":o.left="-=20";break;case"bottom":o.top="-=20"}t.toolbar2.animate(o,200,function(){t.toolbar2.hide()}),t.$elem.trigger("toolbar2Hidden")},gettoolbar2Element:function(){return this.toolbar2.find(".tool-items")}};t.fn.toolbar2=function(o){if(t.isPlainObject(o))return this.each(function(){var i=Object.create(e);i.init(o,this),t(this).data("toolbar2Obj",i)});if("string"==typeof o&&0!==o.indexOf("_")){var i=t(this).data("toolbar2Obj"),s=i[o];return s.apply(i,t.makeArray(arguments).slice(1))}},t.fn.toolbar2.options={content:"#myContent",position:"top",hideOntouchend:!1,zIndex:120}}(jQuery,window,document);